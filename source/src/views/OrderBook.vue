    ...
    <main>
        <article>
            <v-container class="content">
                <h2>Книга ордеров</h2>
                <article v-if="orderBookStore.orders.length > 0" class="orders">
                    <v-row class="d-flex ma-2">
                        <v-col>
                            ...
                            <v-table ref="firstTable" fixed-header :height="tableHeight">
                                ...
                                <tbody>
                                    <template v-for="value in orderBookStore.orders.slice(0, tableLimit)" :key="value">
                                        <tr v-for="(ask, askIndex) in value.asks.slice(0, tableLimit)" :key="askIndex">
                        ...
                        <v-col>
                            ...
                            <v-table fixed-header :height="tableHeight">
                                ...
                                <tbody>
                                    <template v-for="value in orderBookStore.orders.slice(0, tableLimit)" :key="value">
                                        <tr v-for="(bid, bidsIndex) in value.bids.slice(0, tableLimit)"
                                            :key="bidsIndex">
